...
isConfirm = input('are you sure you want to deploy for thefinder_taiwan (y/n)?\n')
if isConfirm.lower() != 'y':
    print('stopped deployment')
    sys.exit(1)

hostname = '35.221.225.91'
#port = 22
#username = 'gmtool'
#password = 'vkdejvkdls12#$'
...
ssh.connect(hostname,username='thefinder',key_filename='d:/projects/bs_crm/utility/thefinder_ssh_private.pem')
...
scp.put('./configs/config-thefinder.js', '~/docker/bs_crm/dockerfile/app/config.js')
print('translating config file .......... Done!\n')

# remove bs_crm container
sshExecCommand('cd ~/docker/bs_crm/dockerfile; sudo ./remove_container.sh')
print('removing bs_crm container.......... Done!\n')

# build bs_crm docker
sshExecCommand('cd ~/docker/bs_crm/dockerfile; sudo ./build_bs_crm.sh')
print('building bs_crm container.......... Done!\n')

# run bs_crm container
sshExecCommand('cd ~/docker/bs_crm/dockerfile; sudo ./run_container.sh')
