...
isConfirm = input('are you sure you want to deploy for pang.Sky (y/n)?\n')
if isConfirm.lower() != 'y':
    print('stopped deployment')
    sys.exit(1)

hostname = '211.110.181.170'
port = 57522
username = 'root'
...
scp.put('./configs/config-pangSky.js', '~/docker/bs_crm/dockerfile/app/config.js')
