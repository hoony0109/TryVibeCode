...
isConfirm = input('are you sure you want to deploy for so7 (y/n)?\n')
if isConfirm.lower() != 'y':
    print('stopped deployment')
    sys.exit(1)

hostname = '121.37.146.129'
port = 22
username = 'root'
password = '43rDFm3V6FG72ikO'
...
scp.put('./configs/config-so7.js', '~/docker/bs_crm/dockerfile/app/config.js')
