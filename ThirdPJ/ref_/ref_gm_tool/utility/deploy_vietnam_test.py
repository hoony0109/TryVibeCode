...
isConfirm = input('are you sure you want to deploy for vietnam test (y/n)?\n')
if isConfirm.lower() != 'y':
    print('stopped deployment')
    sys.exit(1)

hostname = '123.31.11.182'
port = 28022
username = 'sg280'
password = 'MlV06nbh7Kx21jhNhPxl'
...
scp.put('./configs/config-vietnam-test.js', '~/docker/bs_crm/dockerfile/app/config.js')
